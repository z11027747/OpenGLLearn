...
{
    //贴图
    vec3 diffuseCol = texture(material.texture_diffuse1, uv).rgb;
    vec3 specularCol = texture(material.texture_specular1, uv).rgb;
...
void main()
{
    ...
    FragColor = vec4(dirLightResult * objectColor, 1.0);
}