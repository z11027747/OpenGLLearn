...
static void _6_Matrix()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		testShader.setF("time", time);

		//变换矩阵
		//	相当于transform
		mat4 trans = mat4(1.0f);
		trans = glm::translate(trans, vec3(0.5f, -0.5f, 0.0f));
		trans = glm::rotate(trans, time, vec3(0.0f, 0.0f, 1.0f));
		testShader.setM4("trans", glm::value_ptr(trans));
